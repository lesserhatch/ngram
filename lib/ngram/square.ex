defmodule Ngram.Square do
  ...
  ## Example
      ...
      iex> is_open?(%Ngram.Square{name: :sq11, letter: nil})
      true

      iex> is_open?(%Ngram.Square{name: :sq11, letter: "O"})
      false

      iex> is_open?(%Ngram.Square{name: :sq11, letter: "X"})
      false
  """
